...
const FAQ_DOC = {
  ...
  items: [
    ...
    { _key: "faq-03", question: "What does your development process look like?",          answer: "Research → Wireframe → Prototype → Build → Polish. I prefer async collaboration via Notion and Figma with weekly milestone check-ins so there are no surprises at the end." },
