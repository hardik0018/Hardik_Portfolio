...
const defaultMarkers: PolaroidMarker[] = [
  { id: "polaroid-rajkot", location: [22.3039, 70.8022], image: "https://images.unsplash.com/photo-1595658658481-d53d3f999875?w=300&h=300&fit=crop", caption: "Rajkot, India", rotate: -3 },
]
